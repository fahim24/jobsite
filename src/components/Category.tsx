			...
			<div className="container mx-auto px-10 py-20">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
					<div className="bg-white px-8 py-6 rounded-lg shadow-xl flex justify-between items-center Jhover">
						<div className="space-y-2 gap-2 text-CDark ">
							<h6 className=" font-bold text-xl">Design</h6>
							<p className=" opacity-70 text-sm">47 jobs</p>
						</div>
						<button className=" size-10 shrink-0 bg-white bg-opacity-20 flex items-center justify-center text-white hover:text-CDark font-bold rounded-full">
							<FontAwesomeIcon icon={faArrowRight} />
						</button>
					</div>
					<div className="bg-white px-8 py-6 rounded-lg shadow-xl flex justify-between items-center Jhover">
